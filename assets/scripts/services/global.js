...
angular.module('appbuilder').factory('Global', [
    function() {
        var _this = this;
        _this._data = {
            user: window.user,
        ...
        //console.log('global.js data: ' + JSON.stringify(_this._data, null, 4));
        return _this._data;
    }
]);
 ...
 */
angular.module('appbuilder').factory('$fileUploader', [ '$compile', '$rootScope', '$http', '$window', function ($compile, $rootScope, $http, $window) {
    'use strict';
...
angular.module('appbuilder').factory('fileReader', [ '$q', '$log', function ($q, $log) {
